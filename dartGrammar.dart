...
class DartGrammar extends ExecutableGrammar {
  CombinatorialParser variableDeclaration, declaredIdentifier, finalConstVarOrType, varOrType, initializedVariableDeclaration, 
  initializedIdentifier, initializedIdentifierList, functionSignature, returnType, functionBody, block, formalParameterList,
  normalFormalParameter, normalFormalParameters, optionalFormalParameters, optionalPositionalFormalParameters, namedFormalParameters, namedFormalParameter, 
  simpleFormalParameter, fieldFormalParameter, defaultFormalParameter, defaultNamedParameter, classDefinition, mixins, classMemberDefinition, 
  methodSignature, declaration, staticFinalDeclarationList, staticFinalDeclaration, operatorSignature, operator, binaryOperator, 
  getterSignature, setterSignature, constructorSignature, redirection, initializers, superCallOrFieldInitializer, fieldInitializer, 
  factoryConstructorSignature, redirectingFactoryConstructorSignature, superclass, interfaces, mixinApplication, typeParameter,
  ...
  relationalExpression, relationalOperator, shiftExpression, shiftOperator, additiveExpression, additiveOperator, multiplicativeExpression,
  multiplicativeOperator, unaryExpression, prefixOperator, unaryOperator, postfixExpression, postfixOperator, selector, 
  incrementOperator, assignableExpression, assignableSelector, identifier, IDENTIFIER_NO_DOLLAR, IDENTIFIER, BUILT_IN_IDENTIFIER, 
  IDENTIFIER_START, IDENTIFIER_START_NO_DOLLAR, IDENTIFIER_PART_NO_DOLLAR, IDENTIFIER_PART, qualified, typeTest, isOperator,
  typeCast, asOperator, argumentDefinitionTest, statements, statement, expressionStatement, localVariableDeclaration, 
  nonLabelledStatement, localFunctionDeclaration, ifStatement, forStatement, forLoopParts, forInitializerStatement, whileStatement,
  doStatement, constantConstructorSignature, switchStatement, switchCase, defaultCase, tryStatement, onPart, catchPart, finallyPart,
  returnStatement, label, breakStatement, continueStatement, assertStatement, topLevelDefinition, getOrSet, libraryDefinition, 
  libraryName, importOrExport, libraryImport, combinator, identifierList, libraryExport, partDirective, partHeader, partDeclaration,
  scriptDefinition, scriptTag, uri, type, typeName, typeArguments, typeList, typeAlias, typeAliasBody, functionTypeAlias,
  functionPrefix, LETTER, DIGIT, WHITESPACE, SINGLE_LINE_COMMENT, MULTI_LINE_COMMENT, ASSERT, BREAK, CASE, CATCH, CLASS, CONST,
  CONTINUE, DEFAULT, DO, ELSE, EXTENDS, FALSE, FINAL, FINALLY, FOR, IF, IN, IS, NEW, NULL, RETHROW, RETURN, SUPER, SWITCH, THIS, THROW, 
  TRUE, TRY, VAR, VOID, WHILE, WITH, backSlash, colon, comma, dollar, dot,
  doubleQuote, equalSign, lparen, minus, plus, rparen, semicolon, singleQuote,
  tripleDoubleQuote, tripleSingleQuote, ABSTRACT, AS, DYNAMIC, EXPORT, 
  EXTERNAL, FACTORY, GET, IMPLEMENTS, IMPORT, LIBRARY, OPERATOR, PART, SET, STATIC, TYPEDEF, HIDE, SHOW, OF, ON;
